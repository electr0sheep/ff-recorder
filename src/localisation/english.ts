...
const ENGLISH: Translations = {
  ...
  [Phrase.FFXIVWebSocketURLDescription]: 'WebSocket URL for IINACT or OverlayPlugin. Default is ws://127.0.0.1:10501/ws',
  [Phrase.RecordFFXIVDescription]: 'Whether the application should record FFXIV.',
  [Phrase.FFXIV]: 'FFXIV',
  [Phrase.RecordFFXIVLabel]: 'Record FFXIV',
  [Phrase.FFXIVWebSocketURLLabel]: 'IINACT WebSocket URL',
  ...
  [Phrase.VideoCategoryFFXIVRaidsLabel]: 'Raids',
  [Phrase.FFXIVCloudUploadRaidsDescription]: 'If raid recordings should be uploaded to the cloud.',
